...
public class TestBecario {
	...
	private static void testConstructor1Normal() {
		...
		testConstructor1("12345678Z", "Juan", "Nadie Nadie", LocalDate.of(1950, 3, 15), "juan.nadie@alum.us.es",
				new BecaImpl("ABC1234", TipoBeca.ORDINARIA), LocalDate.of(2015, 1, 1));
	}


	private static void testConstructor2Normal() {
		System.out.println("\n==================================Probando el segundo constructor");
		testConstructor2("12345678Z", "Juan", "Nadie Nadie",LocalDate.of(1950, 3, 15), "juan.nadie@alum.us.es", "ABC1234",
	...
	private static void testConstructor1Excepcion() {
		...
		testConstructor1("12345678Z", "Juan", "Nadie Nadie",LocalDate.of(1950, 3, 15), "juan.nadie@alum.us.es",
				new BecaImpl("ABC1234", TipoBeca.ORDINARIA), LocalDate.of(2010, 1, 1));
	}
	...
	private static void testSetFechaComienzoNormal() {
		...
		Becario b = new BecarioImpl("12345678Z", "Juan", "Nadie Nadie",LocalDate.of(1950, 3, 15), "juan.nadie@alum.us.es",
				new BecaImpl("ABC1234", TipoBeca.ORDINARIA), LocalDate.of(2015,1, 1));
	...
	private static void testConstructor1(String dni, String nombre, String apellidos, LocalDate fechaNacimiento, String email,
		...
		try {
			...
			System.out.println("******************** Se ha capturado una excepción inesperada.");
										...
										/******** CONSTRUCTOR 2 ******/
	private static void testConstructor2(String dni, String nombre,String apellidos, LocalDate fechaNacimiento, String email,
			String codigo, Double cuantiaTotal, Integer duracion, TipoBeca tipo, LocalDate fechaComienzo) {

		try {
			Becario b = new BecarioImpl(dni, nombre, apellidos, fechaNacimiento, email, codigo, cuantiaTotal, duracion,
					tipo, fechaComienzo);
			mostrarBecario(b);
		} catch (ExcepcionBecarioNoValido e) {
			System.out.println("******************** Se ha capturado la excepción ExcepcionBecarioNoValido");
