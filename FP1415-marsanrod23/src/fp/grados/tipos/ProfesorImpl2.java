...
//		if(!(getDepartamento().equals(asig.getDepartamento()))/* || ((asig.getDepartamento() == null) && !(getDepartamento() == null))*/){
...
//	}
	...
	public void imparteAsignatura(Asignatura asig, Double dedicacion) {
		...
		creditosPorAsignatura.put(asig, dedicacion);//actualizas el dato de la dedicacion
	...
	public Double dedicacionAsignatura(Asignatura asig) {
		Double res = 0.;
		if(creditosPorAsignatura.containsKey(asig)){//si contiene la llave
			res = creditosPorAsignatura.get(asig);//me da el valor asignado
		}
	...
	public void eliminaAsignatura(Asignatura asig) {
		creditosPorAsignatura.remove(asig);//la clave es asig
	...
	public List<Asignatura> getAsignaturas() {
		return new ArrayList<Asignatura>(creditosPorAsignatura.keySet());//para sacar las claves
	}


	@Override
	public List<Double> getCreditos() {
		return new ArrayList<Double>(creditosPorAsignatura.values());//para sacar los valores
	}
